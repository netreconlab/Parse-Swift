...
__Fixes__
* Add backwards compatability to Xcode 13.2. Building on Xcode <13.3 only works for SPM ([#90](https://github.com/netreconlab/Parse-Swift/pull/90)), thanks to [Corey Baker](https://github.com/cbaker6).
