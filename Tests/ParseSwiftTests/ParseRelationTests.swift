...
class ParseRelationTests: XCTestCase, @unchecked Sendable {
    ...
    func testParseObjectRelation() throws {
        ...
        let decoded4 = String(decoding: encoded4, as: UTF8.self)
        ...
        let decoded5 = String(decoding: encoded5, as: UTF8.self)
