...
class ParseObjectAsyncTests: XCTestCase { // swiftlint:disable:this type_body_length
    ...
    final class GameScoreClass: ParseObject {
        ...
        public static func == (
            lhs: ParseObjectAsyncTests.GameScoreClass,
            rhs: ParseObjectAsyncTests.GameScoreClass
        ) -> Bool {
    ...
    final class GameClass: ParseObject {
        ...
        public static func == (
            lhs: ParseObjectAsyncTests.GameClass,
            rhs: ParseObjectAsyncTests.GameClass
        ) -> Bool {
            lhs.hasSameObjectId(as: rhs) &&
            lhs.createdAt == rhs.createdAt &&
            lhs.updatedAt == rhs.updatedAt
